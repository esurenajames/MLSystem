...
// ====================================================================================================================
	...
	public static function unichr($c, $unicode=true) {
		if (!$unicode) {
			...
			// two bytes
			return intval(0xC0 | $c >> 6).intval(0x80 | $c & 0x3F);
		} elseif ($c <= 0xFFFF) {
			// three bytes
			return intval(0xE0 | $c >> 12).intval(0x80 | $c >> 6 & 0x3F).intval(0x80 | $c & 0x3F);
		} elseif ($c <= 0x10FFFF) {
			// four bytes
			return intval(0xF0 | $c >> 18).intval(0x80 | $c >> 12 & 0x3F).intval(0x80 | $c >> 6 & 0x3F).chr(0x80 | $c & 0x3F);
		} else {
			return '';
		}
	}
