...
class TCPDF {
    ...
    public function Header() {
        // Logo
        $image_file = K_PATH_IMAGES.'image001.png';
        $this->Image($image_file, 5, 5, 60, '', 'PNG', '', 'T', false, 300, '', false, false, 0, false, false, false);
        // Set font
        $this->SetFont('helvetica', 'B', 12);
        // Title
        // $this->Cell(0, 5, 'M.C. Biliber Report Generation', 0, false, 'C', 0, '', 0, false, 'M', 'M');
    }
