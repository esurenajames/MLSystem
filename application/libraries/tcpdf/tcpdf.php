...
class TCPDF {
 ...
 //    // set bacground image
 //    $img_file = K_PATH_IMAGES.'approvedWM.png';
 //    $this->Image($img_file, 0, 0, 250, 250, '', '', '', false, 300, '', false, false, 0);
 ...
 //    $img_file = K_PATH_IMAGES.'approvedWM.png';
 //    $this->Image($img_file, 0, 0, 300, 250, '', '', '', false, 250, '', false, false, 0);
...
//============================================================+
  ...
  class ApprovedWatermark extends TCPDF {
  public function Header() {
      // Get the current page break margin
      $bMargin = $this->getBreakMargin();
      ...
      // Define the path to the image that you want to use as watermark.
      $img_file = FCPATH.'/uploads/approvedWM.png';
  ...
  class PendingWatermark extends TCPDF {
	  public function Header() {
	    // Get the current page break margin
	    $bMargin = $this->getBreakMargin();
	    ...
	    // Define the path to the image that you want to use as watermark.
	    $img_file = FCPATH.'/uploads/PendingWM.png';
