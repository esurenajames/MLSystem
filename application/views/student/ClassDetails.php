...
<script type="text/javascript">
  ...
  $(function () {
    ...
    UserTable = $('#example1').DataTable({
      "pageLength": 10,
      "ajax": { url: '<?php echo base_url()."/admin_controller/getStudentSubjectClassList/". $this->uri->segment(3); ?>', type: 'POST', "dataSrc": "" },
      "columns": [  { data: "Code" }
                    , { data: "SubjectName" }
                    , { data: "Units" }
                    , { data: "TotalStudents" }
                    ...
                    , {
                      data: "StatusId", "render": function (data, type, row) {
                        return '<a href="<?php echo base_url() ?>home/subjectStudents/'+row.ClassSubjectId+'" class="btn btn-default" title="View"><span class="fa fa-eye"></span></a>';
                      }
                    },
      ],
