  ...
  <tbody>
    <?php
      ...
      foreach ($EmailAddress as $value) 
      {
        ...
        {
          $action = '<a onclick="confirm(\'Are you sure you want to deactivate this email?\', \''.$value['BorrowerEmailId'].'\', 0, \'BorrowerEmail\')" class="btn btn-danger btn-sm" title="Deactivate"><span class="fa fa-close"></span></a>';
        }
        else if($value['StatusId'] == 1 && $value['IsPrimary'] == 0)
        {
          $action = '<a onclick="confirm(\'Are you sure you want to deactivate this email?\', \''.$value['BorrowerEmailId'].'\', 0, \'BorrowerEmail\')" class="btn btn-danger btn-sm" title="Deactivate"><span class="fa fa-close"></span></a> <a onclick="confirm(\'Are you sure you want to set this email as your primary email?\', \''.$value['BorrowerEmailId'].'\', 2, \'BorrowerEmail\')" class="btn btn-success btn-sm" title="Make as primary"><span class="fa fa-check-circle"></span></a>';
        }
        else
        {
