<div class="content-wrapper">
  <?php if(in_array('41', $subModule)) { ?>
    ...
    <div class="modal fade" id="modalNewCategory">
      <div class="modal-dialog modal-md">
        <div class="modal-content">
          ...
          <form action="<?php echo base_url(); ?>admin_controller/AddAsset/" class="frmInsert" method="post">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="hidden" class="form-control" id="txtCategoryId" name="CategoryId" value="1">
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
    ...
    <section class="content">
      <div class="box">
        ...
        <div class="box-body">
          <button type="button" class="btn btn-primary pull-right" data-toggle="modal" data-target="#modalNewCategory">Add Record</button>
          <br>
          <br>
...
<script>
  ...
  function confirm(Text, CategoryId, updateType)
  { 
    swal({
      title: 'Confirm',
      text: Text,
  ...
  {
    $.ajax({
      url: '<?php echo base_url()?>' + "/admin_controller/getAssetDetails",
      type: "POST",
      async: false,
      data: {
        Id : CategoryId
  ...
  function refreshPage(){
    var url = '<?php echo base_url()."datatables_controller/Categories/"; ?>';
  ...
  $(function () {
    UserTable = $('#example1').DataTable({
      "pageLength": 10,
      "ajax": { url: '<?php echo base_url()."/datatables_controller/Categories/"; ?>', type: 'POST', "dataSrc": "" },
      "columns": [  { data: "ReferenceNo" }
                    ...
                    { data: "DateUpdated" }, 
                    {
                      data: "StatusId", "render": function (data, type, row) {
                      if(row.StatusId == 1){
                          return '<a onclick="confirm(\'Are you sure you want to deactivate this Category?\', \''+row.CategoryId+'\', 0)" class="btn btn-danger" title="Deactivate"><span class="fa fa-close"></span></a> <a onclick="Edit('+row.CategoryId+')" data-toggle="modal" data-target="#modalNewCategory" class="btn btn-info" title="Edit"><span class="fa fa-edit"></span></a>';
                        }
                        else if(row.StatusId == 0){
                          return '<a onclick="confirm(\'Are you sure you want to re-activate this Category?\', \''+row.CategoryId+'\', 1)" class="btn btn-warning" title="Deactivate"><span class="fa fa-refresh"></span></a>';
                        }
                        else{
                          return "N/A";
                        }
