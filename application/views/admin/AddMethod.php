...
<div class="content-wrapper">
  ...
  <div class="modal fade" id="modalNewMethod">
...
<script>
  ...
  function confirm(Text, MethodId, updateType)
  { 
    swal({
      title: 'Confirm',
      text: Text,
      ...
      $.ajax({                
          ...
          success: function(data)
          {
            ...
            swal({
              title: 'Success!',
              text: 'Method successfully updated!',
              type: 'success',
              buttonsStyling: false,
              confirmButtonClass: 'btn btn-primary'
            });
  ...
  function Edit(MethodId)
  {
    $.ajax({
      url: '<?php echo base_url()?>' + "/admin_controller/getMethodDetails",
      type: "POST",
      async: false,
      data: {
        Id : MethodId
      ...
      success: function(data)
      {
        $('#txtMethod').val(data['Name']);
        $('#txtDescription').val(data['Description']);
        $('#txtMethodId').val(MethodId);
        $('#txtFormType').val(2);
      },
  ...
  function refreshPage(){
    var url = '<?php echo base_url()."datatables_controller/Methods/"; ?>';
  ...
  $(function () {
    ...
    $('#modalNewMethod').on('hide.bs.modal', function () {
      $('#txtFormType').val(1)
    })
