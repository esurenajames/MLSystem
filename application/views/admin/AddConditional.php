...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="#">Conditional Chaarges</a></li>
    </ol>
  </section>
    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Conditional Charge Details</h4>
        </div>
      ...
      <?php } if($rows['RoleId'] == 1) /*admin*/ { ?>
        ...
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">List of Conditional Charges</h3>
          </div>
          <div class="box-body">
            <button type="button" class="btn btn-primary pull-right" data-toggle="modal" data-target="#modalNewCharges">Add Conditional Charge</button>
            <br>
            <br>
