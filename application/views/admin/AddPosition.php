    ...
    <div class="modal fade" id="modalNewPosition">
      <div class="modal-dialog modal-md">
        <div class="modal-content">
          ...
          <form action="<?php echo base_url(); ?>admin_controller/AddPosition/" class="frminsert" method="post">
...
<script>
  ...
  function confirm(Text, PositionId, updateType)
  { 
    swal({
      title: 'Confirm',
      text: Text,
  ...
  {
    $.ajax({
      url: '<?php echo base_url()?>' + "/admin_controller/getPositionDetails",
      type: "POST",
      async: false,
      data: {
        Id : PositionId
      ...
      success: function(data)
      {
        $('#txtPosition').val(data['Name']);
        $('#txtDescription').val(data['Description']);
        $('#txtPositionId').val(PositionId);
        $('#txtFormType').val(2);
      },
  ...
  function refreshPage(){
    var url = '<?php echo base_url()."datatables_controller/Positions/"; ?>';
