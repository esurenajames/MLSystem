    ...
    <section class="content">
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Generate Demographics Report</h3>
        </div>
        <div class="box-body">
          <form autocomplete="off" action="<?php echo base_url(); ?>loanapplication_controller/generateReport/4" method="post" enctype="multipart/form-data" id="generateReport">
            <div class="modal-body">
              <div class="row">
                ...
                <div class="col-md-6">
                  <label>Year To</label>
                  <select class="form-control" id="selectYearTo" name="YearTo">
                    <?php 
                      foreach ($Year as $value) 
                      {
                        $selected = (date("Y") == $value['Year']) ? 'selected' : '';
