  ...
  <section class="content">
      ...
      <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
          ...
          <div class="info-box-content">
            <span class="info-box-text">Pending <br> Loans</span>
      ...
      <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
          ...
          <div class="info-box-content">
            <span class="info-box-text">Approved <br> Loans</span>
            <span class="info-box-number">10</span>
          </div>
          <!-- /.info-box-content -->
        </div>
      ...
      <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
          ...
          <div class="info-box-content">
            <span class="info-box-text">Disapproved <br> Loans</span>
      ...
      <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
          ...
          <div class="info-box-content">
            <span class="info-box-text">Missed <br> Payments</span>
            <span class="info-box-number">Php 41,410</span>
          </div>
          <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
		        ...
		        <div class="row">
		          ...
		          <div class="col-md-4">
		            <ul class="chart-legend clearfix">
		              <li><i class="fa fa-circle-o text-green"></i> <small>Approved</small> </li>
		              <li><i class="fa fa-circle-o text-red"></i> <small>Disapproved</small> </li>
		              <li><i class="fa fa-circle-o text-yellow"></i> <small>Pending</small></li>
		            </ul>
		          </div>
		        </div>
		      </div>
