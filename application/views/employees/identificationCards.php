    ...
    <?php
      foreach ($Ids as $value) 
      {
        ...
        else if($value['StatusId'] == 0)
        {
          ...
          $action = '<a class="btn btn-sm btn-success" href="' . base_url() .'/admin_controller/download/1/'.$value['EmployeeIdentificationId'].'" title="Download"><span class="fa fa-download"></span></a> <a onclick="confirmID(\'Are you sure you want to re-activate this Id?\', \''.$value['EmployeeIdentificationId'].'\', 1)" class="btn btn-warning btn-sm" title="Reactivate"><span class="fa fa-refresh"></span></a>';
        }
