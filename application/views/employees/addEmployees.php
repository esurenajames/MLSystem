    ...
    UserTable = $('#example1').DataTable({
      ...
      "columns": [  
                    ...
                    { data: "DateCreated" }, 
                    {
                      data: "StatusId", "render": function (data, type, row) {
                      if(row.StatusId == 1){
                          return '<a href="<?php echo base_url()."home/employeeDetails/"; ?>'+row.EmployeeId+'" class="btn btn-default" title="View"><span class="fa fa-info-circle"></span></a> <a onclick="confirm(\'Are you sure you want to deactivate this employee?\', \''+row.EmployeeId+'\', 0)" class="btn btn-danger" title="Deactivate"><span class="fa fa-close"></span></a>';
                        }
                        else
                        {
                          return '<a href="<?php echo base_url()."home/employeeDetails/"; ?>'+row.EmployeeId+'" class="btn btn-default" title="View"><span class="fa fa-info-circle"></span></a> <a onclick="confirm(\'Are you sure you want to re-activate this employee?\', \''+row.EmployeeId+'\', 1)" class="btn btn-success" title="Re-activate"><span class="fa fa-refresh"></span></a>';
                        }
                      }
                    },
      ],
