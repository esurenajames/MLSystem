...
<script>
  ...
  function confirm(Text, RequirementId, updateType)
  { 
    swal({
      title: 'Confirm',
      text: Text,
      ...
      $.ajax({                
          ...
          success: function(data)
          {
            ...
            swal({
              title: 'Success!',
              text: 'Requirement successfully updated!',
              type: 'success',
              buttonsStyling: false,
              confirmButtonClass: 'btn btn-primary'
            });
  ...
  {
    $.ajax({
      url: '<?php echo base_url()?>' + "/admin_controller/getRequirementDetails",
      type: "POST",
      async: false,
      data: {
        Id : RequirementId
  ...
  function refreshPage(){
    var url = '<?php echo base_url()."datatables_controller/Requirements/"; ?>';
  ...
  $(function () {
    ...
    $('#modalNewRequirement').on('hide.bs.modal', function () {
      $('#txtFormType').val(1)
    })
